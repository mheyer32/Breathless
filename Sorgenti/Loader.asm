...
; La lettura/scrittura della configurazione non  permessa sui dischetti
...
ReadConfig
		...
		CALLSYS	Open
		move.l	d0,file(a5)
		beq	RCout		;Esce senza errori se non c' il file
...
WriteConfig
		...
		CALLSYS	Open
		move.l	d0,file(a5)
		beq	WCout		;Esce senza errori se non pu creare il file
		move.l	d0,a4		;Conserva in a4 il pun. al file
...
ReadTextures
		tst.b	TextDirFlag(a5)	;Test se la dir  stata caricata
...
RTopenok
		...
		addq.l	#4,a4			;Salta primo puntatore, perch la texture num. 0  inutilizzata
...
RTfound		move.l	8(a0),d4		;d4=offset
		...
		addq.l	#4,(a4)+		;Il pun. alla texture deve puntare 2 word pi avanti
		add.l	d5,a2
...
ReadObjects
		tst.b	ObjDirFlag(a5)	;Test se la dir  stata caricata
...
ROopenok
		...
		addq.l	#4,a4			;Salta primo puntatore, perch l'oggetto num. 0  inutilizzato
		bra.s	ROnext
...
LLDloopel1	tst.l	(a0)
		...
		beq.s	LLDemptylist		;Se=0, la lista  vuota e va alla prossima lista
...
LLDloopobj	clr.l	d0
		...
		bne.s	LLDobjnopl	;Se non  il player, salta
...
TextDirFlag	ds.b	1	;Se=TRUE, la dir delle texture  stata gi caricata
ObjDirFlag	ds.b	1	;Se=TRUE, la dir degli oggetti  stata gi caricata
