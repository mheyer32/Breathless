...
MFWloope	move.l	(a2)+,d2	;d2=distance
		...
		lea	8192(a3),a3		;Se c'è nebbia, passa alla lighting table per la nebbia
...
MFWnofog	add.l	d1,d0			;Somma global light
		...
		cmp.w	#31,d0			;Se troppo grande, usa l'ultima tabella (massimo dell'oscurità o della nebbia)
		ble.s	MFWlitok
		lea	(31<<8)(a3),a3
		bra.s	MFWlitout
MFWlitok	lsl.l	#8,d0
...
;		bmi	MTCnexty
	...
	bmi	MTCnexty
		...
		lea	LightingTable(a5),a3	;a3=Pun. alla lighting table
		bpl.s	MTCnofog		;Se non c'è nebbia, salta
		lea	8192(a3),a3		;Se c'è nebbia, passa alla lighting table per la nebbia
...
MTCnofog	add.l	d4,d5			;Somma global light
		...
		cmp.w	#31,d5			;Se troppo grande, usa l'ultima tabella (massimo dell'oscurità o della nebbia)
		ble.s	MTClitok
		lea	(31<<8)(a3),a3
		bra.s	MTClitout
MTClitok	lsl.l	#8,d5
...
;		bmi	MTFnexty
	...
	bmi	MTFnexty
		...
		tst.b	bl_Illumination+1(a3)	;Test flag nebbia
		lea	LightingTable(a5),a3	;a3=Pun. alla lighting table
		bpl.s	MTFnofog		;Se non c'è nebbia, salta
		lea	8192(a3),a3		;Se c'è nebbia, passa alla lighting table per la nebbia
		moveq	#0,d4			;Azzera global light
